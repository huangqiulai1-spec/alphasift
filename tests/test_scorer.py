...
def test_stability_factor_penalizes_high_daily_volatility_and_deep_drawdown():
    df = pd.DataFrame([
        {"code": "controlled", "change_pct": 0.5, "volatility_20d_pct": 22.0, "max_drawdown_20d_pct": -4.0, "atr_20_pct": 2.5},
        {"code": "wild", "change_pct": 0.5, "volatility_20d_pct": 75.0, "max_drawdown_20d_pct": -24.0, "atr_20_pct": 9.0},
    ])
